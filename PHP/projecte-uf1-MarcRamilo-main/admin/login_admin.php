...
include_once("./verificacio/validacio_admin.php");
...
if (isset($_POST['sub_signin'])) {
    ...
    } elseif (isset($resposta['admin']) && $resposta['admin']) {
        // Si login és correcte, guardar l'usuari a la sessió
        $_SESSION['user_logged'] = $resposta;
        header("Location: ./welcome_admin.php");
        exit;
    } else {
        // Usuari no es admin
        $missatge_error = "L'usuari no es admin";
    }
}
?>
